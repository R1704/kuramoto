...
- Core compute: `src/simulation/Simulation.js` orchestrates `src/simulation/{buffers,pipelines,readback,resize}.js` + WGSL in `src/shaders/sources/*.js` (barrel: `src/shaders/shaders.js`)
